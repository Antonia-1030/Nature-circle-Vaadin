...
@PageTitle("Products")
@Route(value = "product-detail/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
public class ProductsView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "product-detail/%s/edit";
    ...
    public ProductsView(SampleBookService sampleBookService) {
